...
-- WITH A DAMN DOT AT THE END, LET'S STRESS THAT
local root = "scripts.lib.customhealthapi." -- Replace with the location of the 'customhealthapi' folder in your mod (e.g. "modscripts.dependencies.customhealthapi.")
local modname = "Custom Health API for World Wrath" -- Replace with "Custom Health API" + the name of your mod (e.g. "Custom Health API (My Cool Isaac Mod)"
local modinitials = "WW" -- Replace with the initials of your mod (e.g. "MCIM")
